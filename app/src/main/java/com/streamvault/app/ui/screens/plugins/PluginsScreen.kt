            ...
            if (configuration != null) {
                ...
                LazyColumn(
                    ...
                    if (uiState.plugins.isEmpty() && !uiState.isLoading) {
                        item {
                            Text(
                                text = "No compatible MegaStream plugins are installed.",
...
private fun PluginInstallPanel(
    ...
    Column(
        ...
        Text(
            text = "Manual installs are detected when this screen refreshes. Compatible plugins expose the MegaStream plugin service.",
            style = MaterialTheme.typography.bodySmall,
...
private fun PluginInstallUrlDialog(
    ...
    PremiumDialog(
        ...
        subtitle = "Enter the direct APK URL. MegaStream will download it and open the installer.",
        onDismissRequest = {
            keyboardController?.hide()

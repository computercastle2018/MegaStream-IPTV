...
<p align="center">
	<a href="https://github.com/computercastle2018/MegaStream-IPTV/releases/latest/download/MegaStream.apk"><img src="https://img.shields.io/badge/Download-MegaStream.apk-2ea44f?style=for-the-badge&logo=android" alt="Download MegaStream APK" /></a>
	<a href="https://github.com/computercastle2018/MegaStream-IPTV/releases/latest"><img src="https://img.shields.io/github/v/release/computercastle2018/MegaStream-IPTV?display_name=tag&style=for-the-badge&color=0f766e" alt="Latest MegaStream release" /></a>
	<a href="https://github.com/computercastle2018/MegaStream-IPTV/releases"><img src="https://img.shields.io/github/downloads/computercastle2018/MegaStream-IPTV/total?style=for-the-badge&color=8b5cf6" alt="Total Downloads" /></a>
	...
	<a href="https://github.com/computercastle2018/MegaStream-IPTV/actions/workflows/release.yml"><img src="https://img.shields.io/github/actions/workflow/status/computercastle2018/MegaStream-IPTV/release.yml?branch=master&style=for-the-badge&label=CI" alt="GitHub Actions status" /></a>
	<a href="https://github.com/computercastle2018"><img src="https://img.shields.io/badge/Developer-megaStation-181717?style=for-the-badge&logo=github" alt="Developer on GitHub" /></a>
	<a href="https://megastation.ee/megastream"><img src="https://img.shields.io/badge/Website-megastation.ee-0f766e?style=for-the-badge" alt="megaStation website" /></a>
	<a href="LICENSE"><img src="https://img.shields.io/badge/License-MegaStream_OSL-0284c7?style=for-the-badge" alt="License" /></a>
</p>

MegaStream is a TV-first IPTV player for Android TV built with Kotlin, Jetpack Compose, Room, Hilt, and Media3.

It is designed for large playlists, remote-friendly browsing, fast provider switching, and a polished living-room playback experience. MegaStream supports `M3U` playlists, `Xtream Codes`, and `Stalker Portal` providers, with dedicated flows for `Live TV`, `Movies`, and `Series`.

Built for Android TV first, MegaStream focuses on the things generic IPTV apps usually get wrong: D-pad navigation, quick channel movement, large-library organization, and a player that still feels good to use from the couch. Phone and tablet installs are also supported, but the primary UX target is TV.

## Preview
<p align="center">
	<a href="https://github.com/computercastle2018/MegaStream-IPTV/raw/master/docs/images/LiveTV.png"><img src="docs/images/LiveTV.png" alt="Live TV" width="88%" /></a>
</p>

<p align="center">
	<a href="https://github.com/computercastle2018/MegaStream-IPTV/raw/master/docs/images/Movies.png"><img src="docs/images/Movies.png" alt="Movies" width="44%" /></a>
	<a href="https://github.com/computercastle2018/MegaStream-IPTV/raw/master/docs/images/MovieInfo.png"><img src="docs/images/MovieInfo.png" alt="Movie Details" width="44%" /></a>
</p>

<p align="center">
	<a href="https://github.com/computercastle2018/MegaStream-IPTV/raw/master/docs/images/Home.png"><img src="docs/images/Home.png" alt="Home" width="19%" /></a>
	<a href="https://github.com/computercastle2018/MegaStream-IPTV/raw/master/docs/images/LiveTV.png"><img src="docs/images/LiveTV.png" alt="Live TV" width="19%" /></a>
	<a href="https://github.com/computercastle2018/MegaStream-IPTV/raw/master/docs/images/ChannelView.png"><img src="docs/images/ChannelView.png" alt="Channel Preview" width="19%" /></a>
	<a href="https://github.com/computercastle2018/MegaStream-IPTV/raw/master/docs/images/Guide.png"><img src="docs/images/Guide.png" alt="Guide" width="19%" /></a>
	<a href="https://github.com/computercastle2018/MegaStream-IPTV/raw/master/docs/images/Settings.png"><img src="docs/images/Settings.png" alt="Settings" width="19%" /></a>
</p>

<p align="center">
	<a href="https://github.com/computercastle2018/MegaStream-IPTV/raw/master/docs/images/SeriesEpisodes.png"><img src="docs/images/SeriesEpisodes.png" alt="Series Episodes" width="32%" /></a>
</p>
...
- MegaStream can be extended with companion Android APK plugins.
- Plugin developers can expose provider, playback, Cast URL rewrite, and host-rendered or native configuration capabilities.
- See the [MegaStream Plugin API](docs/PLUGIN_API.md) docs to create compatible plugins.
...
- [Download latest MegaStream.apk](https://github.com/computercastle2018/MegaStream-IPTV/releases/latest/download/MegaStream.apk)
...
- **megaStation** — [GitHub](https://github.com/computercastle2018) · [Website](https://megastation.ee/megastream)
- **Repository** — [computercastle2018/MegaStream-IPTV](https://github.com/computercastle2018/MegaStream-IPTV)
...
- MegaStream is an IPTV client, not a content provider.
...
As of April 2026, all usage, modification, and distribution are governed by the MegaStream Source-Available License (Non-Commercial), a derivative of the MegaStream Source-Available License.
